...
const Icon = styled.i`${color}${fontSize}`
...
const Emphasize = ({ children }) =>
  <Span color='primary'><b><i>{children}</i></b></Span>
        ...
        */
        return (
          <Flex flexDirection='column'>
            ...
            <p>
              This invoice will expire in {getInvoiceExpiry()} minutes since it was created.
            </p>
            ...
            <CopyToClipboard text={currentPaymentRequest} onCopy={() => window.alert('Payment Request copied to clipboard.')}>
            ...
            <Flex>
              <CopyToClipboard text={process.env.LN_NODE_URI} onCopy={() => window.alert('Node Information copied to clipboard.')}>
                <Button w={200}>Copy Node Information</Button>
              </CopyToClipboard>
              <Button ml={2} active={this.state.showNodeQr} onClick={this.toggleShowNodeQr}>
            ...
            <Button mt={4} active onClick={closeModal}>Close</Button>
            <style jsx>{`
            .qr-wrapper {
              padding: 2em 0;
              margin: 0 auto;
        ...
        */
        return (
          <Flex flexDirection='column'>
            ...
            <Text>
              Satoshi's Place is a Lightning Network ⚡ powered online collaborative artboard. Inspired by <Link target='_blank' href='https://www.youtube.com/watch?v=XnRCZK3KjUY'>Reddit Place</Link>, and the <Link target='_blank' href='http://www.milliondollarhomepage.com/'>Million Dollar Homepage</Link>.
            </Text>
            <Text mt={3}>
              These are the features of the game:
            </Text>
            <ul>
              <li>There are <Span color='orange'><b><i>1 million pixels</i></b></Span> on the canvas.</li>
              <li>Each pixel costs <Span color='orange'><b><i>1 satoshi to paint.</i></b></Span></li>
            ...
            <Flex py={3} justify='center'>
              <UnstyledLink target='_blank' href='https://t.me/satoshisplace'>
                <Flex ml={'-10px'} justify='center' align='center'>
                  <Icon color='primary' className={`fa fa-3x fa-telegram`} />
                  <Text color='primary' ml={3}>
                    <b><u>
                      Oh hey look! It's a telegram group!
                    </u></b>
                  </Text>
                </Flex>
              </UnstyledLink>
            </Flex>
            <Button mt={4} success onClick={closeModal}>Let the games begin!</Button>
          </Flex>
        )
      default:
        return ''
